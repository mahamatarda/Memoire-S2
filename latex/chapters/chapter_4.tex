...
La première composante (PC1, axe horizontal) est fortement influencée par \texttt{bmi\_cat}, variable ordinale à \textbf{4 valeurs discrètes} (sous-poids, normal, surpoids, obèse)~: les individus s'alignent en 4 bandes verticales au lieu de se répartir continûment. La deuxième composante (PC2, axe vertical) est dominée par \texttt{hypertension}, variable \textbf{binaire}~: ses deux seules valeurs produisent un saut net haut/bas, divisant le nuage entre normotendus et hypertendus.
